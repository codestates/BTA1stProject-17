...
function Help() {
  ...
  const handleRecoverWalletBtnClick = () => {
    navigate('/help/recover');
  };
  ...
  return (
    <section css={helpSectionCss}>
      <button css={selectBtnCss} onClick={handleRecoverWalletBtnClick}>
      ...
      <button css={selectBtnCss} onClick={handleMakeWalletBtnClick}>
        <figure className="icon-wrap">
