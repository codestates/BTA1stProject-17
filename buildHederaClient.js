// const { Client, PrivateKey, AccountCreateTransaction, AccountBalanceQuery, Hbar, TransferTransaction, Mnemonic, AccountId } = require('@hashgraph/sdk');
...
// // const makeMnemonic = async () => {
// //     try {
// //         const mnemonic = await Mnemonic.generate12();
// //         // return await Promise.resolve(mnemonic);

// //         let recoveredMnemonic = null;
// //         let privateKey = null;
// //         if (mnemonic) recoveredMnemonic = await Mnemonic.fromString(mnemonic.toString());
// //         if (recoveredMnemonic) privateKey = await recoveredMnemonic.toPrivateKey();
// //         console.log(privateKey._key._key);
// //         return privateKey;
// //     } catch(err) {
// //         console.log(err);
// //     }
...
// // // makeMnemonic().then(res => console.log(res));
